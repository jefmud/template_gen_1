...
template_gen_1 welcomes contributions from the community.
...
- Clone your fork of this repo. `git clone git@github.com:YOUR_GIT_USERNAME/template_gen_1.git`
- Enter the directory `cd template_gen_1`
- Add upstream repo `git remote add upstream https://github.com/jefmud/template_gen_1`
